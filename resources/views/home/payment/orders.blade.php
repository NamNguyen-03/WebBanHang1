...
<section class="orders-section py-5">
    <div class="container" style="width:100%">
        ...
        <div class="table-responsive">
            <table class="table table-bordered text-center shadow-sm" id="ordersTable">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (!userId || !token) {
            tbody.innerHTML = '<tr><td colspan="6" class="text-danger">Vui lòng đăng nhập để xem đơn hàng.</td></tr>';
            return;
        }
        ...
        fetch(`/api/users/${userId}`)
            ...
            .then(data => {
                ...
                if (!orders || orders.length === 0) {
                    tbody.innerHTML = '<tr><td colspan="6" class="text-muted">Chưa có đơn hàng nào.</td></tr>';
                    return;
                }
            ...
            .catch(err => {
                console.error(err);
                tbody.innerHTML = '<tr><td colspan="6" class="text-danger">Lỗi khi tải đơn hàng.</td></tr>';
            });
    });
</script>
